...
class kadima_nav_walker extends Walker_Nav_Menu {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$item_output .= ($args->has_children) ? '&nbsp;<i class="fa fa-angle-down"></i></a>' : '<br/><span class="subMenu">' . $item->description . '</span></a>';
...
function kadima_nav_menu_css_class( $classes ) {
...
function kadima_fallback_page_menu( $args = array() ) {
	...
	$list_args['title_li'] = '';
	$list_args['walker'] = new kadima_walker_page_menu;
...
class kadima_walker_page_menu extends Walker_Page{
	function start_lvl( &$output, $depth = 0, $args = array() ) {
		$indent = str_repeat("\t", $depth);
