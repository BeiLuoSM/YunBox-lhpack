...
<div class="footer">
    ...
    <div class="container footer-container">
        <h1 ><img src="http://localhost/wrd-lh/wp-content/themes/lh/images/ft-bg1.png" alt=""><?php if($wl_theme_options['footer_customizations']) { echo esc_attr($wl_theme_options['footer_customizations']); }?></h1>
        <h2 >ADDRESS:</h2>
        ...
        <ul>
            <li class="facebook hidden-xs" data-toggle="tooltip" data-placement="top" title="Facebook"><a  href="<?php echo esc_url($wl_theme_options['fb_link']); ?> " ><i class="fa fa-facebook"></i></a></li>
            <li class="twitter hidden-xs" data-toggle="tooltip" data-placement="top" title="Twitter"><a href="<?php echo esc_url($wl_theme_options['twitter_link']) ; ?>"><i class="fa fa-twitter"></i></a></li>
            <li class="linkedin hidden-xs" data-toggle="tooltip" data-placement="top" title="Linkedin"><a href="<?php echo esc_url($wl_theme_options['linkedin_link']) ; ?>"><i class="fa fa-linkedin"></i></a></li>
        </ul>
        <br>
