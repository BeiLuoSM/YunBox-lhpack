<div id="post-<?php the_ID(); ?>" <?php post_class('kadima_blog_full'); ?>>
	<div class="post-content-wrap row">
		...
		<ul class="blog-date-left">
			...
			<span class="date">Postde on <?php echo get_the_date('d'); ?></span><h6><?php echo get_the_date('M  y'); ?></h6>
			<?php else : ?>
			<span class="date">Postde on <?php echo get_the_date(); ?></span>
			<?php endif; ?>
			</li>
		</ul>
