/*
* @Author: Marte
* @Date:   2017-05-24 09:29:44
* @Last Modified by:   Marte
* @Last Modified time: 2017-08-11 15:06:40
*/

'use strict';
jQuery(document).ready(function($){
    if(typeof($('.woocommerce-product-gallery__image')) != 'undefined'){
        baguetteBox.run('.woocommerce-product-gallery__image');
    }
})
/* menu */
jQuery(document).ready(function() {
