...
<div class="container">
	<div class="row">
		<div class="col-sm-12  animated animated" style="margin-top:70px;animation-delay: 0.4s; animation-name: fadeInRight;">
...
<?php } ?>
<section class="services wrapper services_line animated animated" id="services_three" style="background-color: #fff;animation-delay: 0.4s; animation-name: fadeInLeft;">
<div class="container">
